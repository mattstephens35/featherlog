    ...
    >
      <defs>
        ...
        <linearGradient id="hero-hill-far" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="var(--hero-hill-far-top)" />
          <stop offset="100%" stopColor="var(--hero-hill-far-bottom)" />
        </linearGradient>
        <linearGradient id="hero-hill-near" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="var(--hero-hill-near-top)" />
          <stop offset="100%" stopColor="var(--hero-hill-near-bottom)" />
        </linearGradient>
        <linearGradient id="hero-water" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="var(--hero-water-top)" />
          <stop offset="100%" stopColor="var(--hero-water-bottom)" />
        </linearGradient>
      </defs>

      <rect width="400" height="300" fill="url(#hero-sky)" />
      <circle cx="320" cy="60" r="36" fill="var(--hero-sun)" opacity="0.85" />
      ...
      <g transform="translate(60 165)">
        <rect x="-3" y="20" width="6" height="34" fill="var(--hero-tree-trunk)" />
        <ellipse cx="0" cy="10" rx="26" ry="24" fill="var(--hero-tree-canopy-dark)" />
        <ellipse cx="-14" cy="22" rx="18" ry="16" fill="var(--hero-tree-canopy-light)" />
        <ellipse cx="16" cy="20" rx="18" ry="16" fill="var(--hero-tree-canopy-light)" />
      </g>

      <g stroke="var(--hero-bird)" strokeWidth="3" strokeLinecap="round" fill="none" opacity="0.75">
